...
public class UtilityColourHuffmanString extends Utility {
	...
	class HuffmanCoding {
			public static void main(String[] args) {
					...
					// System.out.println("Decompressed Data: " + Arrays.toString(decompressedData));
			}
	...
	public Utility createUtility() {
		return new UtilityColourHuffmanString();
	}
    ...
    public void Compress(int[][][] pixels, String outputFileName) throws IOException {
        ...
        ColorQuantization.PX_PER_BOX = (int) Math.ceil((double)ColorQuantization.IMG_WIDTH * (double)ColorQuantization.IMG_HEIGHT / (double)ColorQuantization.NEW_DYN_RANGE);
        ...
        ColorQuantization.cut(px, 0, ColorQuantization.NEW_DYN_RANGE, 0, ColorQuantization.NEW_DYN_RANGE, 0, ColorQuantization.NEW_DYN_RANGE);

        if(ColorQuantization.DEBUG){ ColorQuantization.printPalette(); }
	...
	public static Color [][] readCompressedFile(int[] compressed) throws IOException, ClassNotFoundException
	{
		Color [][] image = null;
			...
			// read in all colors in palette
				int count = 3;
				for(int i = 0; i < numColors; i++){ 
					// System.out.println("r: "+compressed[count]+" g: "+compressed[count+1]+" b: "+compressed[count+2]);
					palette[i] = new Color(compressed[count++], compressed[count++], compressed[count++]); 
				 }
				// System.out.println("palette: "+Arrays.toString(palette));
